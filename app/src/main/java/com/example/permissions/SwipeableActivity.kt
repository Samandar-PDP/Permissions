...
import com.example.permissions.adapter.SwipeAdapter
import com.example.permissions.databinding.ActivitySwipeableBinding
import com.example.permissions.util.Object
...
class SwipeableActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gestureManager.setIconLeft(ContextCompat.getDrawable(this, R.drawable.ic_baseline_email_24))
        gestureManager.setIconRight(ContextCompat.getDrawable(this, R.drawable.ic_baseline_call_24))
